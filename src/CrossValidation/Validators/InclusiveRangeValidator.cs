...
public class InclusiveRangeValidator<TField>(TField fieldValue, TField from, TField to) : Validator
    where TField : IComparable<TField>
{
    ...
    {
        return new CommonException.InclusiveRangeException<TField>(_from, _to);
    }
}